...
class NekoSpy(loader.Module):
    ...
    strings_ua = {
        ...
        "spybl": f"{rei} <b>Поточний чат додано до чорного списку для стеження</b>",
        "spybl_removed": (
            f"{rei} <b>Поточний чат видалено із чорного списку для стеження</b>"
        ),
        "spybl_clear": f"{rei} <b>Чорний список для стеження очищений</b>",
        "spywl": f"{rei} <b>Поточний чат доданий до білого списку для стеження</b>",
        "spywl_removed": (
            f"{rei} <b>Поточний чат видалено з білого списку для стеження</b>"
        ),
        "spywl_clear": f"{rei} <b>Білий список для стеження очищений</b>",
        "whitelist": (
            f"\n{rei} <b>Спостерігаю тільки"
        ...
        "blacklist": (
            f"\n{rei} <b>Ігнорую повідомлень від користувачів/груп:</b>\n{{}}"
        ),
        "chat": f"{groups} <b>Слідкую за повідомленнями у групах</b>\n",
        "pm": f"{pm} <b>Стажу за повідомленнями в особистих повідомленнях</b>\n",
        "deleted_pm": (
        ...
        "edited_pm": (
            ...
            ' href="{message_url}">повідомлення</a> у особистих . Старий вміст:</b>\n{}'
        ),
        "edited_chat": (
            '🔏 <b><a href="{message_url}">Повідомлення</a> у чаті <a href="{}">{}</a> від'
        ...
        "cfg_always_track": (
            "Список чатів, від яких слід відстежувати повідомлення,"
            " незважаючи ні на що"
        ),
        ...
        "cfg_save_sd": "Зберігати медіа, що самознищується.",
    }
