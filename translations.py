...
class Translations(loader.Module):
    ...
    strings_ua = {
        ...
        "pack_saved": (
            "<emoji document_id=5197474765387864959>👍</emoji> <b>Пак перекладів"
            " збережено!</b>"
        ),
        "incorrect_language": (
        ...
        "lang_removed": (
            "<emoji document_id=5197474765387864959>👍</emoji> <b>Переклади скинуті"
            "на стандартні</b>"
        ),
        "check_pack": (
            "<emoji document_id=5312526098750252863>🚫</emoji> <b>Невірний формат"
            "пакет перекладів у засланні</b>"
        ),
        "check_url": (
        ...
        "too_long": (
            ...
            " довге, тому він відправлений у файл.</b>"
        ),
        ...
        "invoke_failed": "<b>🚫 Виклик модуля не вдався! Докладніше у логах</b>",
        ...
        "not_official": (
            ...
            " офіційно підтримується</b>"
        ),
        "requested_join": (
            "💫 <b>Модуль</b> <code>{}</code> <b>запросив дозвіл на приєднання до каналу <a"
            " href='https://t.me/{}'>{}</a></b>\n\n<b>❓ Причина:</b> <i>{}</i>"
        ),
        "fw_error": (
            "<emoji document_id=5877458226823302157>🕒</emoji> <b>Команда"
            "</b> <code>{}</code> <b>викликав FloodWait {} у методі</b> <code> {}</code>"
        ),
        "rpc_error": (
            "<emoji document_id=5877477244938489129>🚫</emoji> <b>Команда"
            "</b> <code>{}</code> <b>не вдалася через помилку RPC:</b>"
            " <code>{}</code>"
        ),
    }
